...
# Match the IMS DNS zone generated by dns_init.sh from the deployment's
# existing MCC/MNC values.  A two-digit MNC is represented as three digits in
# the 3GPP domain (for example, MCC=404/MNC=20 -> mnc020.mcc404).
MCC="${MCC:-001}"
MNC="${MNC:-01}"
